...
1.    Unzip the file 'wp-advanced-importer.zip'.
2.    Upload the ' wp-advanced-importer ' directory to '/wp-content/plugins/' directory using ftp client or upload
3.    Or Upload the wp-advanced-importer.zip file through plugin install in wp admin.
