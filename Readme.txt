...
* Upload the XML to be imported. <br />
* Click on 'Next' to proceed import. <br />

Step-2 Mapping <br />

* The WP fields and the XML nodes are listed, map the WP fields with the corresponding nodes. <br />
...
To more about the product, visit <a href="https://www.wpultimatecsvimporter.com/documentation/all-import/wp-advanced-importer/getting-started/" target="blank"> Documentation </a> 
For technical support and feature request, visit <a href="https://smackcoders.freshdesk.com" target="blank"> Smackcoders support </a>
To know more about our PRO products, visit <a href=" https://www.wpultimatecsvimporter.com " target="blank">WP Ultimate CSV Importer</a>
