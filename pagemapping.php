...
<button type='submit' class="action" name='page_xml' id='page_xml' value='PageMapping' onclick="saveMapping(this.id);">Save Mapping</button>
</div>
</form>
</div><!-- Mapping for Pages -->
